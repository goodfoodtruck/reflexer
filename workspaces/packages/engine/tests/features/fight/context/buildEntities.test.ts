...
describe("FightContextFactory — construction des entités", () => {
    ...
    const buildPlayerTeam = (): TeamMemberData[] => [
        { characterName: "CHARACTER_1", baseStats: { health: 100, energy: 10, armor: 0 }, gambits: [], activePassiveIds: [] },
        { characterName: "CHARACTER_2", baseStats: { health: 100, energy: 10, armor: 0 }, gambits: [], activePassiveIds: [] }
    ]
    ...
    const buildPvpFightConfig = (): PvpFightConfig => ({
        ...
        playerTeam: buildPlayerTeam(),
        opponentTeam: [
            { characterName: "CHARACTER_1", baseStats: { health: 80, energy: 5, armor: 0 }, gambits: [], activePassiveIds: [] },
            { characterName: "CHARACTER_2", baseStats: { health: 120, energy: 8, armor: 0 }, gambits: [], activePassiveIds: [] }
        ]
    })
