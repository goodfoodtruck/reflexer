...
export const TEAM_CONFIGURATION_SCREEN = {
  ...
  overlay:
    'absolute inset-0 bg-gradient-to-b from-slate-950/95 via-slate-950/70 to-slate-950/95 z-0 pointer-events-none',
  scanlines:
    'absolute inset-0 pointer-events-none z-0 opacity-20 bg-[linear-gradient(rgba(255,255,255,0)_50%,rgba(0,0,0,0.25)_50%)] bg-[length:100%_4px]',
  foreground: 'relative z-10 flex flex-col h-full',
  titleContainer: 'flex-none pt-8 pb-4 text-center',
  mainTitle:
    'text-4xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400 uppercase drop-shadow-[0_0_20px_rgba(255,255,255,0.1)]',
  ...
  launchButton:
    'px-16 py-4 bg-slate-900 border-2 border-slate-800 rounded-xl text-slate-600 font-black tracking-widest text-sm cursor-not-allowed uppercase shadow-2xl relative overflow-hidden group',
  styleDiv: 'absolute inset-0 bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(0,0,0,0.2)_10px,rgba(0,0,0,0.2)_20px)] opacity-50',
  styleSpan: 'relative z-10 flex items-center gap-3'
};
