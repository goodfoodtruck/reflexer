...
const TARGET_KINDS = [
  {
    ...
    description: 'Cible un ennemi selon ses caractéristiques et position',
  ...
  },
  {
    ...
    description: 'Cible un allié pour le soutenir ou le protéger',
  ...
  },
  {
    id: 'SELF',
    label: 'Moi-même',
    sub: 'Votre propre personnage',
    description: 'Agit directement sur vous-même (soins, buffs, repositionnement)',
